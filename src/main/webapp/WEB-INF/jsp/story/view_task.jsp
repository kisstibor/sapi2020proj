    ...
    <script id="template-delete-story-confirmation-dialog" type="text/x-handlebars-template">
        <div id="delete-story-confirmation-dialog" class="modal">
            ...
            <div class="modal-footer">
                <a id="cancel-story-button" href="/board" class="btn"><spring:message code="label.cancel"/></a>
                <a id="delete-task-button" href="/board/delete/${story.id}" class="btn btn-primary"><spring:message code="label.delete.story.button"/></a>
            </div>
        </div>
    </script>
</body>
