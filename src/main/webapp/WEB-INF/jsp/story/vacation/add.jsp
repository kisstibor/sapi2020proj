...
<body>
    <h1><spring:message code="label.vacation.add.page.title"/></h1>
    <div class="well page-content">
        <form:form action="/scrumsapientia/story/vacation/add/" commandName="vacation" method="POST" enctype="utf8">
            ...
            <div class="action-buttons">
                ...
                <button id="add-vacation-button" type="submit" class="btn btn-primary"><spring:message
                        code="label.add.vacation.button"/></button>
            </div>
        </form:form>
    </div>
</body>
