...
<body>
    ...
    <div class="well page-content">
        <form:form action="/story/update" commandName="story" method="POST" enctype="utf8">
            ...
            <div id="control-group-title" class="control-group">
                <label for="story-title"><spring:message code="label.story.progress"/>:</label>

                <div class="controls">
                    <form:input id="story-progress" path="progress"/>
                    <form:errors id="error-title" path="progress" cssClass="help-inline"/>
                </div>
            </div>
