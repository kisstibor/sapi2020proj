...
<body>
    ...
    <div class="well page-content">
        <form:form action="/scrumsapientia/story/timelimit/add/${story.id}" commandName="storytimelimit" method="POST" enctype="utf8">
            ...
            <div class="action-buttons">
                ...
                <button id="add-timelimit-button" type="submit" class="btn btn-primary"><spring:message
                        code="label.add.storytimelimit.button"/></button>
            </div>
        </form:form>
    </div>
</body>
