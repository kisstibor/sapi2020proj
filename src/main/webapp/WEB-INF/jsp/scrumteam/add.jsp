...
<body>
    <h1><spring:message code="label.scrumteam.add.page.title"/></h1>
    <div class="well page-content">
    
        <form:form action="/scrumteam/add" commandName="team" method="POST" enctype="utf8">
        
        	<!-- 
        		team.name -> team.getName()
        		team-name -> team.setName(...)
        	 -->
