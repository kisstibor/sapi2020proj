...
<body>
		<h1><spring:message code="label.daily.add.page.title"/></h1>
	    <div class="well page-content">
	        <form:form action="/daily/add" commandName="daily" method="POST" enctype="utf8">
	            <div id="control-group-title" class="control-group">
	                <label for="daily-title"><spring:message code="label.daily.title"/>:</label>
	            ...
	            <div id="control-group-datee" class="control-group">
	                <label for="daily-datee"><spring:message code="label.daily.datee"/>:</label>
	            ...
	            <div id="control-group-duration" class="control-group">
	                <label for="daily-duration"><spring:message code="label.daily.duration"/>:</label>
	            ...
	            <div id="control-group-description" class="control-group">
	                <label for="daily-description"><spring:message code="label.daily.description"/>:</label>
	            ...
	            <div class="action-buttons">
	                <a href="/daily/list" class="btn"><spring:message code="label.cancel"/></a>
	                <button id="add-daily-button" type="submit" class="btn btn-primary"><spring:message
	                        code="label.add.daily.button"/></button>
	            </div>
	        </form:form>
	    </div>    
</body>
