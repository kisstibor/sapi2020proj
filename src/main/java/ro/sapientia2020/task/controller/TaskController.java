package ro.sapientia2020.task.controller;
...
import ro.sapientia2020.task.service.TaskService;
...
public class TaskController {
    ...
    private TaskDTO constructFormObjectForUpdateForm(Task updated) {
        ...
        dto.setLabel(updated.getLabel());
        dto.setPrority(updated.getPriority());
