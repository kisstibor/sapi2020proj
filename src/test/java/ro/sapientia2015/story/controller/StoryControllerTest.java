...
public class StoryControllerTest {
    ...
    public void showAddStoryForm() {
        ...
        assertNull(formObject.getPoint());
    }

    @Test
    public void add() {
        StoryDTO formObject = StoryTestUtil.createFormObject(null, StoryTestUtil.DESCRIPTION, StoryTestUtil.TITLE, StoryTestUtil.POINT);

        Story model = StoryTestUtil.createModel(StoryTestUtil.ID, StoryTestUtil.DESCRIPTION, StoryTestUtil.TITLE, StoryTestUtil.POINT);
    ...
    public void addWithTooLongDescriptionAndTitle() {
        ...
        StoryDTO formObject = StoryTestUtil.createFormObject(null, description, title, 0);
    ...
    public void filter() {
        ...
        List<Story> models = new ArrayList<Story>();
        models.add(StoryTestUtil.createModel(StoryTestUtil.ID, StoryTestUtil.DESCRIPTION, StoryTestUtil.TITLE, StoryTestUtil.POINT));
        models.add(StoryTestUtil.createModel(StoryTestUtil.ID, StoryTestUtil.DESCRIPTION, StoryTestUtil.TITLE, StoryTestUtil.POINT));
        when(serviceMock.findAll()).thenReturn(models);

        String view = controller.filter(model, StoryTestUtil.POINT);
    ...
    public void pointList() {
        ...
        String view = controller.pointList(model);

        verify(serviceMock, times(1)).findAll();
        verifyNoMoreInteractions(serviceMock);
        verifyZeroInteractions(messageSourceMock);

        assertEquals(StoryController.VIEW_POINT_LIST, view);
        assertEquals(StoryTestUtil.POINT * 2, model.asMap().get("total"));
        assertEquals(StoryTestUtil.POINT, model.asMap().get("average"));
    }
    ...
    public void findById() throws NotFoundException {
        ...
        Story found = StoryTestUtil.createModel(StoryTestUtil.ID, StoryTestUtil.DESCRIPTION, StoryTestUtil.TITLE, StoryTestUtil.POINT);
    ...
    public void showUpdateStoryForm() throws NotFoundException {
        ...
        Story updated = StoryTestUtil.createModel(StoryTestUtil.ID, StoryTestUtil.DESCRIPTION, StoryTestUtil.TITLE, StoryTestUtil.POINT);
        ...
        assertEquals(updated.getPoint(), formObject.getPoint());
    }
    ...
    public void update() throws NotFoundException {
        StoryDTO formObject = StoryTestUtil.createFormObject(StoryTestUtil.ID, StoryTestUtil.DESCRIPTION_UPDATED, StoryTestUtil.TITLE_UPDATED, StoryTestUtil.POINT_UPDATED);

        Story model = StoryTestUtil.createModel(StoryTestUtil.ID, StoryTestUtil.DESCRIPTION_UPDATED, StoryTestUtil.TITLE_UPDATED, StoryTestUtil.POINT_UPDATED);
    ...
    public void updateWhenDescriptionAndTitleAreTooLong() throws NotFoundException {
        ...
        StoryDTO formObject = StoryTestUtil.createFormObject(StoryTestUtil.ID, description, title, StoryTestUtil.POINT);
