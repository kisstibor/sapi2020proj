...
public class UserControllerTest {
    ...
    public void showAddUserForm() {
        ...
        assertNull(formObject.getType());
        assertNull(formObject.getName());
    }

    @Test
    public void add() {
        UserDTO formObject =UserTestUtil.createFormObject(null, UserTestUtil.TYPE, UserTestUtil.NAME);

        User model = UserTestUtil.createModel(UserTestUtil.ID, UserTestUtil.TYPE, UserTestUtil.NAME);
    ...
    public void findAllSortByNameDesc() {
        ...
        String view = controller.findAllSort(model, 2);
    ...
    @Test
    public void findAllSortByTypeAsc() {
        BindingAwareModelMap model = new BindingAwareModelMap();
        List<User> models = new ArrayList<User>();
        when(serviceMock.findAll()).thenReturn(models);

        String view = controller.findAllSort(model, 3);
    ...
    @Test
    public void findAllSortByTypeDesc() {
        BindingAwareModelMap model = new BindingAwareModelMap();
        List<User> models = new ArrayList<User>();
        when(serviceMock.findAll()).thenReturn(models);

        String view = controller.findAllSort(model, 4);
    ...
    @Test
    public void addWithTooLongTypeAndName() {
        ...
        UserDTO formObject = UserTestUtil.createFormObject(null, type, name);
        ...
        assertEquals(UserController.VIEW_ADD, view);
        assertFieldErrors(result, FIELD_TYPE, FIELD_NAME);
    }
    ...
    public void findById() throws NotFoundException {
        ...
        User found = UserTestUtil.createModel(UserTestUtil.ID, UserTestUtil.TYPE, UserTestUtil.NAME);
    ...
    public void showUpdateUserForm() throws NotFoundException {
        ...
        User updated = UserTestUtil.createModel(UserTestUtil.ID, UserTestUtil.TYPE, UserTestUtil.NAME);
        ...
        assertEquals(updated.getType(), formObject.getType());
    ...
    public void update() throws NotFoundException {
        UserDTO formObject = UserTestUtil.createFormObject(UserTestUtil.ID, UserTestUtil.TYPE_UPDATED, UserTestUtil.NAME_UPDATED);

        User model = UserTestUtil.createModel(UserTestUtil.ID, UserTestUtil.TYPE_UPDATED, UserTestUtil.NAME_UPDATED);
    ...
    @Test
    public void updateWhenTypeAndNameAreTooLong() throws NotFoundException {
        String type = UserTestUtil.createStringWithLength(User.MAX_LENGTH_TYPE + 1);
        String name = UserTestUtil.createStringWithLength(User.MAX_LENGTH_NAME + 1);

        UserDTO formObject = UserTestUtil.createFormObject(UserTestUtil.ID, type, name);
