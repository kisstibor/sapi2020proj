...
public class TaskTestUtil {
    ...
    public static TaskDTO createFormObject(Long id, String description, String title, String state) {
    ...
    public static Task createModel(Long id, String description, String title, String state) {
