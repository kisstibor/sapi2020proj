...
public class RepositoryUserServiceTest {
    ...
    @Test
    public void add() {
        UserDTO dto = UserTestUtil.createFormObject(null, UserTestUtil.TYPE, UserTestUtil.NAME);
    ...
    public void update() throws NotFoundException {
        UserDTO dto = UserTestUtil.createFormObject(UserTestUtil.ID, UserTestUtil.TYPE_UPDATED, UserTestUtil.NAME_UPDATED);
        User model = UserTestUtil.createModel(UserTestUtil.ID, UserTestUtil.TYPE, UserTestUtil.NAME);
