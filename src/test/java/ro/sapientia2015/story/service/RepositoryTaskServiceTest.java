...
public class RepositoryTaskServiceTest {
    ...
    @Test
    public void add() {
        TaskDTO dto = TaskTestUtil.createFormObject(null, TaskTestUtil.DESCRIPTION, TaskTestUtil.TITLE, TaskTestUtil.STATE);
    ...
    public void update() throws NotFoundException {
        TaskDTO dto = TaskTestUtil.createFormObject(TaskTestUtil.ID, TaskTestUtil.DESCRIPTION_UPDATED, TaskTestUtil.TITLE_UPDATED, TaskTestUtil.STATE);
        Task model = TaskTestUtil.createModel(TaskTestUtil.ID, TaskTestUtil.DESCRIPTION, TaskTestUtil.TITLE, TaskTestUtil.STATE);
        ...
        assertEquals(dto.getState(), actual.getState());
    }
