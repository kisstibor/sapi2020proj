...
public class RepositoryTaskServiceTest {
    ...
    @Test
    public void add() {
        TaskDTO dto = TaskTestUtil.createFormObject(null, TaskTestUtil.DESCRIPTION, TaskTestUtil.TITLE);
    ...
    public void update() throws NotFoundException {
        TaskDTO dto = TaskTestUtil.createFormObject(TaskTestUtil.ID, TaskTestUtil.DESCRIPTION_UPDATED, TaskTestUtil.TITLE_UPDATED);
        Task model = TaskTestUtil.createModel(TaskTestUtil.ID, TaskTestUtil.DESCRIPTION, TaskTestUtil.TITLE);
