...
public class RepositoryScrumTeamServiceTest {
    ...
    @Test
    public void add() {
        ScrumTeamDTO dto = ScrumTeamTestUtil.createFormObject(null, ScrumTeamTestUtil.MEMBERS, ScrumTeamTestUtil.NAME);
    ...
    public void deleteById() throws NotFoundException {
        ScrumTeam model = ScrumTeamTestUtil.createModel(ScrumTeamTestUtil.ID, ScrumTeamTestUtil.MEMBERS, ScrumTeamTestUtil.NAME);
    ...
    public void update() throws NotFoundException {
    	ScrumTeamDTO dto = ScrumTeamTestUtil.createFormObject(ScrumTeamTestUtil.ID, ScrumTeamTestUtil.UPDATED_MEMBERS, ScrumTeamTestUtil.NAME_UPDATED);
        ScrumTeam model = ScrumTeamTestUtil.createModel(ScrumTeamTestUtil.ID, ScrumTeamTestUtil.MEMBERS, ScrumTeamTestUtil.NAME);
