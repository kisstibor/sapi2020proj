...
public class ITTaskControllerTest {
    ...
    private static final String FORM_FIELD_PRIORITY = "priority";
    ...
    public void showAddForm() throws Exception {
        mockMvc.perform(get("/task/add"))
        		...
        		.andExpect(model().attribute(TaskController.MODEL_ATTRIBUTE, hasProperty("priority", isEmptyOrNullString())));
    }
    ...
    public void addWhenTitleAndDescriptionAreTooLong() throws Exception {
        ...
        String priority = TaskTestUtil.createStringWithLength(Task.MAX_LENGTH_DESCRIPTION + 1);

        mockMvc.perform(post("/task/add")
                .contentType(MediaType.APPLICATION_FORM_URLENCODED)
                .param(FORM_FIELD_DESCRIPTION, description)
                .param(FORM_FIELD_TITLE, title)
                .param(FORM_FIELD_PRIORITY, priority)
                .sessionAttr(TaskController.MODEL_ATTRIBUTE, new TaskDTO())
        )
                .andExpect(status().isOk())
                .andExpect(view().name(TaskController.VIEW_ADD))
                ...
                .andExpect(model().attributeHasFieldErrors(TaskController.MODEL_ATTRIBUTE, "priority"))
                .andExpect(model().attribute(TaskController.MODEL_ATTRIBUTE, hasProperty("id", nullValue())))
                ...
                .andExpect(model().attribute(TaskController.MODEL_ATTRIBUTE, hasProperty("priority", is(priority))));
    }
    ...
    public void add() throws Exception {
        ...
        mockMvc.perform(post("/task/add")
                ...
                .param(FORM_FIELD_PRIORITY, "HIGH")
                .sessionAttr(TaskController.MODEL_ATTRIBUTE, new TaskDTO())
        )
                .andExpect(status().isOk())
    ...
    public void findById() throws Exception {
        mockMvc.perform(get("/task/{id}", 1L))
                ...
                .andExpect(model().attribute(TaskController.MODEL_ATTRIBUTE, hasProperty("priority", is("HIGH"))));
    }
