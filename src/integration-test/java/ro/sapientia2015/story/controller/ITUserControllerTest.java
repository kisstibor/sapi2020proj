...
public class ITUserControllerTest {
    ...
    private static final String FORM_FIELD_EXPERIENCE = "experience";
    ...
    public void showAddForm() throws Exception {
        mockMvc.perform(get("/user/add"))
                ...
                .andExpect(model().attribute(UserController.MODEL_ATTRIBUTE, hasProperty("description", isEmptyOrNullString())))
                .andExpect(model().attribute(UserController.MODEL_ATTRIBUTE, hasProperty("title", isEmptyOrNullString())))
        		.andExpect(model().attribute(UserController.MODEL_ATTRIBUTE, hasProperty("experience", isEmptyOrNullString())));
    }
    ...
    public void addEmpty() throws Exception {
        mockMvc.perform(post("/user/add")
                ...
                .andExpect(view().name(UserController.VIEW_ADD))
                .andExpect(forwardedUrl("/WEB-INF/jsp/user/add.jsp"))
                .andExpect(model().attributeHasFieldErrors(UserController.MODEL_ATTRIBUTE, "title"))
                .andExpect(model().attribute(UserController.MODEL_ATTRIBUTE, hasProperty("id", nullValue())))
                .andExpect(model().attribute(UserController.MODEL_ATTRIBUTE, hasProperty("description", isEmptyOrNullString())))
                .andExpect(model().attribute(UserController.MODEL_ATTRIBUTE, hasProperty("title", isEmptyOrNullString())))
                .andExpect(model().attribute(UserController.MODEL_ATTRIBUTE, hasProperty("experience", isEmptyOrNullString())));
    ...
    public void addWhenTitleAndDescriptionAreTooLong() throws Exception {
        ...
        mockMvc.perform(post("/user/add")
                ...
                .andExpect(forwardedUrl("/WEB-INF/jsp/user/add.jsp"))
                .andExpect(model().attributeHasFieldErrors(UserController.MODEL_ATTRIBUTE, "title"))
                .andExpect(model().attributeHasFieldErrors(UserController.MODEL_ATTRIBUTE, "description"))
                .andExpect(model().attribute(UserController.MODEL_ATTRIBUTE, hasProperty("id", nullValue())))
                .andExpect(model().attribute(UserController.MODEL_ATTRIBUTE, hasProperty("description", is(description))))
                .andExpect(model().attribute(UserController.MODEL_ATTRIBUTE, hasProperty("title", is(title))))
                .andExpect(model().attribute(UserController.MODEL_ATTRIBUTE, hasProperty("experience", isEmptyOrNullString())));
    }
    ...
    public void add() throws Exception {
        ...
        mockMvc.perform(post("/user/add")
                ...
                .param(FORM_FIELD_DESCRIPTION, "description")
                .param(FORM_FIELD_TITLE, "title")
                .param(FORM_FIELD_EXPERIENCE, "experience")
                .sessionAttr(UserController.MODEL_ATTRIBUTE, new UserDTO())
        )
                .andExpect(status().isOk())
                .andExpect(view().name(expectedRedirectViewPath))
                .andExpect(model().attribute(UserController.PARAMETER_ID, is("4L")))
                .andExpect(flash().attribute(UserController.FLASH_MESSAGE_KEY_FEEDBACK, is("User entry: Junior Programmer was added.")));
    }
        ...
        mockMvc.perform(get("/"))
                ...
                .andExpect(model().attribute(UserController.MODEL_ATTRIBUTE_LIST, hasItem(
                        allOf(
                                ...
                                hasProperty("description", is("User1")),
                                hasProperty("title", is("IT specialist")),
                                hasProperty("experience", is(1L))
                        )
                )))
                .andExpect(model().attribute(UserController.MODEL_ATTRIBUTE_LIST, hasItem(
                        allOf(
                                hasProperty("id", is(2L)),
                                hasProperty("description", is("User2")),
                                hasProperty("title", is("Software Engineer")),
                                hasProperty("experience", is(1L))
                        )
                )))
                .andExpect(model().attribute(UserController.MODEL_ATTRIBUTE_LIST, hasItem(
                        allOf(
                                ...
                                hasProperty("description", is("User3")),
                                hasProperty("title", is("Consultant")),
                                hasProperty("experience", is(1L))
                        )
                )));
    }
    ...
    public void findById() throws Exception {
        mockMvc.perform(get("/user/{id}", 1L))
                ...
                .andExpect(model().attribute(UserController.MODEL_ATTRIBUTE, hasProperty("description", is("User1"))))
                .andExpect(model().attribute(UserController.MODEL_ATTRIBUTE, hasProperty("title", is("IT specialist"))))
        		.andExpect(model().attribute(UserController.MODEL_ATTRIBUTE, hasProperty("experience", is(1L))));
    }

    @Test
    @ExpectedDatabase("userData.xml")
    public void findByIdWhenIsNotFound() throws Exception {
        mockMvc.perform(get("/user/{id}", 4L))
    ...
    public void deleteById() throws Exception {
        ...
        mockMvc.perform(get("/user/delete/{id}", 3L))
                .andExpect(status().isOk())
                .andExpect(view().name(expectedRedirectViewPath))
                .andExpect(flash().attribute(UserController.FLASH_MESSAGE_KEY_FEEDBACK, is("User entry: Consultant was deleted.")));
    }

    @Test
    @ExpectedDatabase("userData.xml")
    public void deleteByIdWhenIsNotFound() throws Exception {
        mockMvc.perform(get("/user/delete/{id}", 4L))
                .andExpect(status().isNotFound())
                .andExpect(view().name(ErrorController.VIEW_NOT_FOUND))
                .andExpect(forwardedUrl("/WEB-INF/jsp/error/404.jsp"));
    }
    ...
    public void showUpdateForm() throws Exception {
        mockMvc.perform(get("/user/update/{id}", 1L))
                ...
                .andExpect(model().attribute(UserController.MODEL_ATTRIBUTE, hasProperty("id", is(3L))))
                .andExpect(model().attribute(UserController.MODEL_ATTRIBUTE, hasProperty("description", is("User nr3"))))
                .andExpect(model().attribute(UserController.MODEL_ATTRIBUTE, hasProperty("title", is("Consultant"))))
        		.andExpect(model().attribute(UserController.MODEL_ATTRIBUTE, hasProperty("experience", is(2L))));
    ...
    public void updateEmpty() throws Exception {
        mockMvc.perform(post("/user/update")
                ...
                .andExpect(model().attribute(UserController.MODEL_ATTRIBUTE, hasProperty("description", isEmptyOrNullString())))
                .andExpect(model().attribute(UserController.MODEL_ATTRIBUTE, hasProperty("title", isEmptyOrNullString())))
        		.andExpect(model().attribute(UserController.MODEL_ATTRIBUTE, hasProperty("experience", nullValue())));
    }

    @Test
    @ExpectedDatabase("userData.xml")
    public void updateWhenTitleAndDescriptionAreTooLong() throws Exception {
        String title = UserTestUtil.createStringWithLength(Story.MAX_LENGTH_TITLE + 1);
        String description = UserTestUtil.createStringWithLength(Story.MAX_LENGTH_DESCRIPTION + 1);
    ...
    public void update() throws Exception {
        ...
        mockMvc.perform(post("/user/update")
                ...
                .andExpect(status().isOk())
                .andExpect(view().name(expectedRedirectViewPath))
                .andExpect(model().attribute(UserController.PARAMETER_ID, is("3")))
                .andExpect(flash().attribute(UserController.FLASH_MESSAGE_KEY_FEEDBACK, is("User entry: Consultant was updated.")));
    }
